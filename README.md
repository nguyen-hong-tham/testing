...
- **Thư mục: Mô hình nghiệp vụ Coolstore/**
  ...
  - `man hinh gio hang.drawio` - Mô hình màn hình giỏ hàng Coolstore

**Nội dung:** Bài tập về phân tích thiết kế hệ thống thông qua các diagram, bao gồm cả case study Coolstore (hệ thống thương mại điện tử)
...
**Các tệp tin:**
- `Class_exercise_LT_Nguyen Ngoc Nhien.docx` - Bài tập lớp của Nguyễn Ngọc Nhiên
- `Class_exercise_LT_Luong Thi Thuy Quyen.docx` - Bài tập lớp của Lương Thị Thuỷ Quyên
- `Class_exercise_LT_Nguyen Hong Tham.docx` - Bài tập lớp của Nguyễn Hồng Thẩm
- `PRACTICE.docx` - Tài liệu thực hành

**Nội dung:** Phân chia đầu vào thành các miền tương đương, thiết kế test cases cho từng miền, và xác định các điều kiện biên
...
**Các tệp tin:**
- `BT06_01_KiemThuBangQuyetDinh.docx` - Kiểm thử bảng quyết định (Decision Table Testing)
- `BT06-02-KiemThuTrangThai.docx` - Kiểm thử chuyển đổi trạng thái (State Transition Testing)
- `BT06_LyThuyet_Nguyen Ngoc Nhien.docx` - Lý thuyết của Nguyễn Ngọc Nhiên
- `BT06_LyThuyet_Nguyen Hong Tham.docx` - Lý thuyết của Nguyễn Hồng Thẩm
- `BT06_LyThuyet_Luong Thi Thuy Quyen.pdf` - Lý thuyết của Lương Thị Thuỷ Quyên

**Nội dung:** Áp dụng các kỹ thuật kiểm thử hộp đen: Decision Table Testing, State Transition Testing, và các kỹ thuật Black Box khác
...
**Các tệp tin:**
- `BÀI 7.docx` - Báo cáo bài 7
- `Test Design Workflow.xlsx` - Bảng tính thiết kế test workflow

**Nội dung:** Thiết kế test cases dựa trên các quy trình (workflows) và luồng hoạt động của hệ thống
...
**Nội dung:** Phân tích và mô hình hóa yêu cầu cho đề tài dự án, bao gồm mô hình khái niệm và sơ đồ tổng quát
...
1. **Phân tích và thiết kế hệ thống** - Học cách thiết kế hệ thống từ mô hình khái niệm đến C4 Architecture
2. **Kỹ thuật kiểm thử** - Nắm vững các kỹ thuật kiểm thử: Black Box Testing, Equivalence Partitioning, Decision Tables, State Transition
3. **Kế hoạch kiểm thử** - Xây dựng kế hoạch kiểm thử toàn diện cho các hệ thống
4. **Thực hành lập trình** - Áp dụng các khái niệm lập trình C++ thông qua Jupyter Notebooks
